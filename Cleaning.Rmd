...
```{r read, cache=TRUE}
rawdf <- read_excel("data/OBS_APSO_compiled_USYD.XLSX")
# glimpse(df)
...
```{r missingFactorPlot, cache=TRUE}
...
```{r outlierBplot, cache=TRUE, warning=FALSE, message=FALSE, fig.width=8, fig.height=8}
# subset numeric data
...
```{r outlierBplot2, cache=TRUE, warning=FALSE, message=FALSE, fig.width=8, fig.height=8}
